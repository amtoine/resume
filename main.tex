...
% job title/career
\cvjobtitle{Data Science Student,\\[0.2em] Reinforcement Learning \newline Intern at InstaDeep, Paris}
...
% \cvaddress{76 rue de Roaminville, 93260, Paris, France}
\cvaddress{37 chemin du Prieure, 17000, La Rochelle, France}
% phone number
\cvphone{+33 7 64 42 97 00}
% personal website
%\cvsite{https://a2n-s.github.io/graphic.github.io/}
% email address
\cvmail{Antoine.stevan@student.isae-supaero.fr}
% pgp key
...
\addtofrontsidebar{
	...
	\profilesection{Social Network}
		\begin{icontable}{2.5em}{1em}
			\social{\faLinkedin}
				...
				{\underline{Professional page}}
			\social{\faGithub}
				{https://github.com/a2n-s}
				{\underline{Computer science projects page}}
		\end{icontable}
	...
	\profilesection{Languages}
        ...
        \skill{\includegraphics[scale=.3]{pics/lsf.png}}{LSF - beginner}
        
	\profilesection{Hard Skills}
		\skill{\faWindows}{Linux, Arch, Windows, VMs}
		\skill{\faCode}{Python, LaTeX, C, C++, Java, Processing, Assembly, Arduino, CamL, Racket}
		\skill{\faList}{MySQL, PostGreSQL, Redis}
		\skill{\faFlask}{PyTorch, NumPy, Pandas, SciPy, Scikit-Learn}
		\skill{\faTty}{sh, bash, ssh, git, docker}
		\skill{\faDesktop}{Jupyter, Google Colab, Google Cloud, Cluster Computing, SpreadSheet, Gimp, Blender}
		\skill{\faCloud}{markdown, org, css, JavaScript, html}
...
\addtobacksidebar{
	\profilesection{Memberships}
    	\begin{memberships}
    		\membership[4em]{pics/instadeep.logo.png}
    		{
    		    \href{https://www.instadeep.com/}{\underline{InstaDeep}}, "decision making AI for the enterprise" 
    		}
    		\membership[4em]{pics/sureli.png}
    		{
        		The \href{https://github.com/SuReLI}{\underline{SuReLI lab}}\newline
    		}
    		\membership[3em]{pics/isae.png}
    		{
    	    	VP of the    		    \textit{\href{https://github.com/Supaero-Computer-Science-Club}{Supaero Computer Science Club}}\newline
    		}
    		\membership[4em]{pics/innovspace.png}
    		{
...
\cvsection{About me \& Objectives}
    \cvsubsection{
        Interested in ML \& RL, language and human-machine interactions.\newline
        Master of science, $3^{rd}$ year student at ISAE-Supaero, research track.\newline
        I am applying to the 2022-2023 year in the MVA Master's 2 degree to further my knowledge of Machine Learning and its foundations.
    }
...
\cvsection{Extra-Curricular Activities}
    \begin{cvtable}
    	\cvitemshort{\includegraphics[scale=0.01]{pics/arch.png} Arch}{Configuring and building software for my ArchLinux distro.}
