...
\cvsection{About me \& Objectives}
    \cvsubsection{
        ...
        \newline
        Interested in distributed computation, cryptographic techniques, zero-knowledge proofs and the Rust
...
%\cvsection{Awards}
\cvsection{Diplomas}
    \cvpubitem{ISAE Supaero}{Engineer graduate diploma}
        {}{2022}
...
\cvsection{Extra-Curricular Activities}
    \begin{cvtable}
        \cvitemshort{
            \includegraphics[scale=0.01]{res/images/arch.png} Arch
        }{Building software and configuration for my ArchLinux system.}
