...
\cvaddress{14 chemin du Valon, 31400, Toulouse, France}
% phone number
...
\cvsection{About me \& Objectives}
    \cvsubsection{
		...
		\newline
		Interested in decentralized storage, cryptographic techniques and the \texttt{rust}
		programming language as well,
		I am applying for a fixed-term contract in the Dragoon project.
    }
...
\cvsection{Extra-Curricular Activities}
    \begin{cvtable}
		...
		\cvitemshort{\faBook ~ Books}{
			...
			\link{https://doc.rust-lang.org/stable/book/}{\texttt{rust}} and
			\link{https://www.nushell.sh/book/}{\texttt{nushell}} books.}
